{
  "about": "Sobre",
  "about_vision_text": "Muitos de nós usam multiplos serviços de armazenamento em nuvem, armazenamentos que não possuem backup e colocam seus arquivos em risco. nós dependemos do armazenamento em nuvem de serviços como Google Photos e iCloud, que tem restrições como limite de capacidade e interoperabilidade quase zero entre serviços e sistemas operacionais. Photo albums shouldn’t be stuck in a device ecosystem, or harvested for advertising data. They should be OS agnostic, permanent and personally owned. Data we create is our legacy, that will long outlive us—open source technology is the only way to ensure we retain absolute control over the data that defines our lives, at unlimited scale.",
